 ...
 * See the abstract class {@link me.mastadons.command.BasicCommandListener}
...
public interface CommandListener {
	...
	/**
	 * Whether the provided class is String array or {@link me.mastadons.command.flag.CommandFlagList}
	 ...
	 */
	private static boolean isArgumentClass(Class<?> clazz) {
		return clazz.equals(String[].class) || clazz.equals(CommandFlagList.class);
	}
	
	/**
	 * Whether the provided class is an instance of {@link org.bukkit.command.CommandSender}
	 * @param clazz The class to check
	 * @return Whether the class can be casted to a CommandSender or not
	 */
	private static boolean isCommandSenderClass(Class<?> clazz) {
		try { 
